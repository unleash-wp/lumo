...
argument-hint: "[theme-name] or interactive"
---
...
node .claude/skills/brand-guidelines/scripts/inject-brand-context.cjs --json | head -30
...
- `brand-guidelines` - Brand context extraction and sync
