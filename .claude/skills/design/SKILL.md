...
```bash
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/search.py --domain style --query "swiss editorial"
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/search.py --domain palette --query "warm earthy"
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/search.py --domain texture --query "risograph"
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/search.py --domain layout --query "centered grid"
```

### Poster: Build Brief

```bash
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/search.py --poster-brief --topic "AI Conference" --query "minimal grid"
```

### Poster: Generate Prompt

```bash
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/generate.py --topic "AI Conference"
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/generate.py --topic "AI Conference" --query "swiss" --aspect a2
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/generate.py --topic "AI Conference" --style "Swiss Editorial Grid" --seed 42
```
...
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/analyze.py --input-dir /path/to/posters

# Re-cluster + regenerate CSVs
~/.claude/skills/.venv/bin/python3 ~/.claude/skills/design/scripts/poster/cluster.py
```
